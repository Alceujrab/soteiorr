@php
    $googleLoginEnabled = app(\App\Services\GoogleOAuthService::class)->isEnabled();
@endphp
@if ($googleLoginEnabled)
    <div class="space-y-3">
        <a href="{{ route('auth.google.redirect') }}"
            class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-semibold border border-slate-700 bg-white text-slate-800 hover:bg-slate-100 transition">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="w-5 h-5" aria-hidden="true">
                ...
                <path fill="#4CAF50" d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.2 35.3 26.7 36 24 36c-5.3 0-9.7-3.3-11.3-8l-6.5 5C9.6 39.6 16.2 44 24 44z"/>
        ...
        <div class="flex items-center gap-3">
            ...
            <span class="text-[10px] uppercase tracking-wider text-slate-500">ou</span>
            <div class="h-px flex-1 bg-slate-800"></div>
        </div>
    </div>
@endif
