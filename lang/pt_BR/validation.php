...
return [
    ...
    'custom' => [
        'accepted_regulation' => [
            'accepted' => 'Você precisa ler e aceitar o regulamento para se cadastrar.',
        ],
        'birth_date' => [
            'before_or_equal' => 'É obrigatório ter 18 anos ou mais para se cadastrar.',
        ],
        'cpf' => [
            'unique' => 'Este CPF já está cadastrado. Faça login ou recupere sua senha.',
            'size' => 'Informe um CPF válido.',
        ],
        'email' => [
            'unique' => 'Este e-mail já está cadastrado. Faça login ou use outro e-mail.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'accepted_regulation' => 'aceite do regulamento',
