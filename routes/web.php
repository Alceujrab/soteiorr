...
Route::post('/admin/raffles/{raffle}/destroy-request', [AdminController::class, 'requestDestroyRaffle'])->name('admin.raffles.destroy.request');
Route::get('/admin/raffles/{raffle}/destroy-confirm', [AdminController::class, 'showDestroyConfirm'])->name('admin.raffles.destroy.confirm');
Route::post('/admin/raffles/{raffle}/destroy-confirm', [AdminController::class, 'confirmDestroyRaffle'])->name('admin.raffles.destroy.confirm.submit');
Route::post('/admin/raffles/{raffle}/destroy-resend', [AdminController::class, 'resendDestroyCode'])->name('admin.raffles.destroy.resend');
